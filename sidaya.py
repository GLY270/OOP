...
def submit():
    conn=sqlite3.connect('C:/Users/STUDENT5/Desktop')
    c=conn.cursor()
...
def query():
    conn=sqlite3.connect('C:/Users/STUDENT6/Desktop/Personal _info.db')
    c=conn.cursor()
...
def delete():
    conn=sqlite3.connect('C:/Users/STUDENT6/Desktop/Personal _info.db')
    c=conn.cursor()
    c.execute("DELETE from Student_info WHERE oid=", oid=delete-box.get())
    records=c.fetchall()
