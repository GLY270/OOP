...
def submit():
    conn=sqlite3.connect('C:/Users/STUDENT5/Documents/personal_info.db')
    c=conn.cursor()
...
def query():
    ...
    for record in records:
        print_records+=(record[0])+""+str(record[1])+""+str(record[2])+""+str(record[3])+""+str(record[4])+" "+str(record[5])+"\n"
...
def edit():
    ...
    save_btn.grid(row=12, column=0, columnspan=2, pady=10, ipadx=140)
